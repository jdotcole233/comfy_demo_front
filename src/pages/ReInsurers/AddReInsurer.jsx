...
function AddInsurer({ edit, toggle, data, closed }) {
  ...
  useEffect(() => {
    if (data) {
      ...
      setSelectedCountry({
        label: data?.reinsurer.reinsurer_address.country,
        value: data?.reinsurer.reinsurer_address.country,
      });
  ...
  const [updateReinsurer] = useMutation(UPDATE_REINSURER, {
    refetchQueries: [
      { query: REINSURER, variables: { id: data?.reinsurer.reinsurer_id } },
    ],
  });
  ...
  useEffect(() => {
    if (selectedInsurer) {
      ...
      setSelectedCountry(
        countries.find(
          (country) =>
            country.label === selectedInsurer?.insurer_address.country
        )
      );
    ...
    <div className="col-md-12">
      <fieldset className="border-form p-2 mb-2">
        <legend className="w-auto" style={{ fontSize: 16 }}>
          {!edit ? "Create new reinsurer" : "Edit reinsurer"}
        </legend>
        <div className="row">
          <div className="col-md-12">
            <div className="form-group">
              ...
              <input
                ...
                name="re_company_name"
                type="text"
                className="form-control"
                placeholder="Company name"
              />
              {errors.re_company_name && (
                <p className="text-danger">{errors.re_company_name.message}</p>
              )}
            </div>
          </div>
          <div className="col-md-6">
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Email"
              />
              {errors.re_company_email && (
                <p className="text-danger">{errors.re_company_email.message}</p>
              )}
            </div>
          </div>
          <div className="col-md-6">
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Website"
              />
              {errors.re_company_website && (
                <p className="text-danger">
                  {errors.re_company_website.message}
                </p>
              )}
            </div>
          </div>
            ...
            <div className="col-md-12">
              <fieldset className="border-form p-2 mb-2">
                ...
                <Alert variant="danger">
                  <strong>
                    Select an Insurer from the list to add as a Reinsurer
                  </strong>
                </Alert>
                <Selector
