    ...
    <div>
      <>
        <DropdownButton
          ...
          title="Action"
        >
          <Dropdown.Item onClick={() => handleViewOfferDetails(offer)}>
            View Details
          </Dropdown.Item>
          {[
            "CEO",
          ...
          !["PARTPAYMENT", "PAID"].includes(offer.payment_status) ? (
            <Dropdown.Item onClick={() => handleViewExtraCharges(offer)}>
              View Deductions
            </Dropdown.Item>
          ) : null}
        </DropdownButton>
        ...
        ["System Administrator", "Finance Executive"].includes(
          ...
          <button
            ...
            className="btn w-md btn-primary btn-sm"
          >
            Payments
          </button>
        ) : null}
      ...
      <Drawer
        width="40%"
        isvisible={showExtraChargesDrawer}
        toggle={() => setShowExtraChargesDrawer(!showExtraChargesDrawer)}
      >
        <UpdateExtraCharges
