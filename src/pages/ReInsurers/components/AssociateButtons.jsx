...
const AssociateButtons = ({ reinsurer, data }) => {
    ...
    useEffect(() => {
        if (selectedAssociate) {
            ...
            setValue("rep_primary_phonenumber", selectedAssociate.rep_primary_phonenumber);
            setValue("rep_secondary_phonenumber", selectedAssociate.rep_secondary_phonenumber);
        }
    }, [selectedAssociate])
    ...
    const handleRemoveAssociate = reinsurer => {
        ...
        swal({
            ...
            icon: "warning",
            title: "Warning",
            text: `Are you sure you want to delete ${reinsurer.rep_first_name + " " + reinsurer.rep_last_name}?`,
            buttons: ["No", {
                text: "Yes",
                closeModal: false,
            }],
            ...
            .then(name => {
                ...
                return removeAssociate({
                    ...
                    refetchQueries: [{ query: REINSURER, variables: { id: state?.reinsurer_id } }]
                });
            })
            .then(json => {
    ...
    const handleUpdateAssociate = values => {
        ...
        swal({
            ...
            updateRep({
                variables: {
                    rep,
                    reinsurer_representative_id: selectedAssociate?.reinsurer_representative_id
                }
            }).then(res => {
    ...
    return (
        <div>
            ...
            <Modal size="lg" show={viewAssociate} onHide={() => setViewAssociate(!viewAssociate)}>
