    ...
    return (
        <div>
            ...
            <Drawer width="50%" isvisible={showCreditNotePreview} toggle={() => setshowCreditNotePreview(!showCreditNotePreview)}>
                {showCreditNotePreview && <PreviewCreditNote offer={selectedOffer?.offer} endorsement={selectedOffer} reinsurer={selectedReinsurer} />}
            </Drawer>
