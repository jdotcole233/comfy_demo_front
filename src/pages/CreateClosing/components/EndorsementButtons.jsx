  ...
  return (
    <>
      ...
      <Prompt
        ...
        toggle={() => setShowDeletePrompt(false)}
      >
        <DeleteEndorsement
      ...
      <Drawer
        width="50%"
        isvisible={showCoverNote}
        toggle={() => setShowCoverNote(false)}
      >
      ...
      <Drawer
        width="50%"
        isvisible={showDebitNote}
        toggle={() => setShowDebitNote(false)}
      >
      ...
      <BottomDrawer
        height="60%"
        isvisible={showCreditNotes}
        toggle={() => setShowCreditNotes(false)}
        size="xl"
      >
        {showCreditNotes && (
          <CreditNotesListing
