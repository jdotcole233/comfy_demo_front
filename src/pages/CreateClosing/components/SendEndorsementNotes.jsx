...
function SendEndorsementNotes({ insurer, doc_number, toggle, endorsement }) {
    ...
    return (
        <>
            <div className={styles.card_header}>
                <h2 className={styles.card_title}>Send Endorsement Cover Note & Debit Note</h2>
...
export default SendEndorsementNotes
