    ...
    <>
      <div className={styles.card_header}>
        ...
        <Alert variant="danger">
          <p>
            This session will send a copy of Endorsement Contract Changes to all
            assoicates participating on this offer as attachment.{" "}
            <b>
              i.e. each PDF document attached to this email will contain only
              the reinsurer's participation
            </b>
          </p>
          <p>
