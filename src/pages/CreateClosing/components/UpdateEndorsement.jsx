...
function UpdateEndorsement({ endorsement, offer }) {
    ...
    return (
        <>
            ...
            <Drawer width="40%" isvisible={showUpdateDrawer} toggle={() => setShowUpdateDrawer(false)}>
                {showUpdateDrawer && <UpdateEndorsementForm toggle={() => setShowUpdateDrawer(false)} offer={offer} endorsement_id={endorsement?.offer_endorsement_id} />}
            </Drawer>
