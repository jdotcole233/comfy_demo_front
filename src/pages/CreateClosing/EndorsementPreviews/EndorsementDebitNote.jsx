            ...
            <div style={{ boxShadow: "1px 2px 2px 5px #f2f2f2" }} className="preview-card container-fluid text-black bg-white">
                <div className="row">
                    ...
                    <div className="col-md-12 text-align-center mt-3 mb-3">
                        <h3 style={{ textAlign: "center", color: "#000", textDecoration: "underline" }}>ENDORSEMENT DEBIT NOTE</h3>
                    </div>
                    <div className="col-md-10 col-12 col-sm-12 col-xs-12 ml-4">
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-md-6 col-8 col-sm-8 col-xs-8">
                                <h3 className="dark-text-value">{offer?.exchange_rate?.ex_currency} {endorsement?.premium.toLocaleString(undefined, { maximumFractionDigits: 2 })}</h3>
                            </div>
                        </div>
                        <div className="row mb-2">
                            <div className="col-md-6 col-6 col-sm-6 col-xs-12">
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-md-6 col-8 col-sm-8 col-xs-8">
                                <h3 className="dark-text-value">{offer?.exchange_rate?.ex_currency} {endorsement?.fac_premium.toLocaleString(undefined, { maximumFractionDigits: 2 })}</h3>
                            </div>
                        </div>
                        <div className="row mb-2">
                            <div className="col-md-6 col-6 col-sm-6 col-xs-12">
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-md-6 col-8 col-sm-8 col-xs-8">
                                <h3 className="dark-text-value">{offer?.exchange_rate?.ex_currency} {endorsement?.commission_amount.toLocaleString(undefined, { maximumFractionDigits: 2 })}</h3>
                            </div>
                        </div>
                        <div className="row mb-2">
                            <div className="col-md-6 col-6 col-sm-6 col-xs-12">
                            ...
                            <div className="col-md-6 col-8 col-sm-8 col-xs-8">
                                <h3 style={{ fontWeight: "bolder" }} className="dark-text-value">{offer?.exchange_rate?.ex_currency}  {(parseFloat(endorsement?.fac_premium) - parseFloat(endorsement?.commission_amount)).toLocaleString(undefined, { maximumFractionDigits: 2 })}</h3>
                            </div>
                        </div>
                    </div>
                </div>
