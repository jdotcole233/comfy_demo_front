...
const OfferDetails = ({ data }) => {
    ...
    return (
        <Fragment>
            <div className="col-xl-4">
                <div className="card">
                    <div className="card-header d-flex justify-content-between bg-soft-primary">
                        ...
                        <button onClick={() => setViewComments(true)} className="btn btn-danger btn-sm d-flex align-items-center ">
            ...
            <Drawer isvisible={viewComments} toggle={() => setViewComments(!viewComments)} width="40%">
                <OfferComments offer={data?.findSingleOffer} setClose={setViewComments} closed={!viewComments} />
            </Drawer>
        </Fragment>
    )
}
