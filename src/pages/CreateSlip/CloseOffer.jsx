    ...
    <>
      <div className={styles.card_header}>
        <h2 className={styles.card_title}>
          Close offer{" "}
          <span style={{ letterSpacing: 5 }} className={`badge badge-warning`}>
            {offer_status}
          </span>
        </h2>
        ...
        <div className="row">
          <Alert variant="danger">
            <p>
              <strong>
                If input field for company is left blank, then no with-holidng
                tax and NIC levy will be charged to them
              </strong>
            </p>

            <p>
              <strong>
                Leave agreed commission as 0 if you want the system to assign
                the initial commission for a particular reinsurer
              </strong>
            </p>
          </Alert>
        </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      value={reinsurer.withholding_tax}
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      name="agreed_brokerage_percentage"
                      value={reinsurer.agreed_brokerage_percentage}
                      onChange={(e) => handleChange(e, key)}
                      min="0"
                      type="number"
                      className="form-control"
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      value={reinsurer.agreed_commission}
                      onChange={(e) => handleChange(e, key)}
                      min="0"
                      type="number"
                      className="form-control"
