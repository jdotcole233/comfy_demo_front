...
import { CREATE_EMPLOYEE, UPDATE_EMPLOYEE } from '../../graphql/mutattions/employees';
    ...
    return (
        <div>
            <div className="row">
                ...
                <form onSubmit={handleSubmit(editing ? handleUpdateEmployee : handleAddEmployee)} className="row">
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="">First name</label>
                            <input type="text" name="employee_first_name" ref={register({ required: "Required" })} className="form-control" placeholder="First name" />
                            {errors.employee_first_name && <p className="text-danger">{errors.employee_first_name.message}</p>}
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="">Last name</label>
                            <input type="text" name="employee_last_name" ref={register({ required: "Required" })} className="form-control" placeholder="Last name" />
                            {errors.employee_last_name && <p className="text-danger">{errors.employee_last_name.message}</p>}
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="">Email</label>
                            <input type="email" name="employee_email" ref={register({
                                required: "Required", pattern: {
                                    value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                                    message: "invalid email address"
                                }
                            })} className="form-control" placeholder="Email" />
                            {errors.employee_email && <p className="text-danger">{errors.employee_email.message}</p>}
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="">Primary phone number</label>
                            <input type="tel" name="employee_phonenumber" ref={register({ required: "Required", minLength: 9, maxLength: 10 })} className="form-control" placeholder="Primary phone number" />
                            {errors.employee_phonenumber && <p className="text-danger">{errors.employee_phonenumber.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="col-md-12">
                        <div className="form-group d-flex justify-content-end">
                            <button type="submit" className="btn btn-sm btn-primary w-md">{editing ? "Update" : "Add"} Employee</button>
                        </div>
                    </div>
                </form>
            </div>
