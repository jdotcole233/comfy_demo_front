...
export default () => {
    ...
    const handleChange = event => {
        ...
        if (value && activePage <= employeesInPages.length - 1) {
            const newList = employees.employees.filter(item => {
            ...
            setEmployeesInPages(chunkArray(employees.employees, 6))
        }
    }
    ...
    useEffect(() => {
        if (employees) {
            const pages = chunkArray(employees.employees, 6);
    ...
    return (
        <>
            {loading && <Loader />}
            {!loading && employees?.employees.length && <div className="page-content">
                                ...
                                <div className="card-body">
                                    <div className="media">
                                        <div className="media-body">
                                            ...
                                            <h4 className="mb-0">{employees.employees.length}</h4>
                                        </div>
                ...
                <Pagination
                    ...
                    itemsCountPerPage={8}
                    totalItemsCount={employees.employees.length}
