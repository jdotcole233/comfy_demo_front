...
function Insurers() {
    ...
    const [asscoiatesCount, setAsscoiatesCount] = useState(0)
    ...
    useEffect(() => {
        if (data) {
            ...
            const pages = chunkArray(data.insurers, 8);
            setInsurersInPages(pages)
            data.insurers.map(insurer => {
                associates += insurer.insurer_associates.length
                return insurer;
            })
            setAsscoiatesCount(associates)
        }
    }, [data])
    ...
    return (
        <div className="page-content">
                            ...
                            <div className="card-body">
                                <div className="media">
                                    <div className="media-body">
                                        ...
                                        <h4 className="mb-0">{asscoiatesCount}</h4>
                                    </div>
            ...
            <Drawer width="40%" isvisible={showAddManager} toggle={() => setshowAddManager(!!0)}>
                <AddManager details={selectedInsurer} toggle={() => setshowAddManager(!!0)} />
            </Drawer>
        </div>
    )
}
