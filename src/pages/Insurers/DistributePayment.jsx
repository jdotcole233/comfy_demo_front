                  ...
                  return !data?.offer_participant[key]
                    ...
                    <fieldset className="border-form p-2 mb-2" key={key}>
                      <legend className={styles.details_title}>
                        {
                          data?.offer_participant[key]?.reinsurer
                            ?.re_company_name
                        }
                      </legend>
                      <div className="row">
                        <div className="col-md-12">
                          {data?.offer_participant[key]
                            ?.offer_participant_payment?.length ? (
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    {data?.offer_participant[
                                      key
                                    ].participant_fac_premium?.toLocaleString(
                                      undefined,
                                  ...
                                  <td>
                                    {reinsurers[key]?.offer_deductions[
                                      reinsurers[key]?.offer_deductions.length -
                                        1
                                    ]?.withholding_tax_paid?.toLocaleString(
                                      undefined,
                                      { maximumFractionDigits: 2 }
                                    )}
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    {reinsurers[key]?.offer_deductions[
                                      reinsurers[key]?.offer_deductions.length -
                                        1
                                    ]?.brokerage_amount_paid?.toLocaleString(
                                      undefined,
                                      { maximumFractionDigits: 2 }
                                    )}
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    {reinsurers[key]?.offer_deductions[
                                      reinsurers[key]?.offer_deductions.length -
                                        1
                                    ]?.commission_taken?.toLocaleString(
                                      undefined,
                                      { maximumFractionDigits: 2 }
                                    )}
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    ].offer_payment_amount?.toLocaleString(
                                      undefined,
                                      { maximumFractionDigits: 2 }
                                    )}
                                  </td>
