        ...
        <div className="">
            ...
            <div className={styles.card_body}>
                <div className="form-group">
                    ...
                    <Selector value={insurer} components={{ Option: InsurerOption }} options={insurersData} onChange={handleChooseInsurer} />
                </div>
                <div className="form-group">
                    <label htmlFor="">Treaty Type</label>
                    <Selector value={treaty_type} placeholder="Treaty Type" options={[
                ...
                <div className="form-group">
                    ...
                    <input name="name" value={treaty_name} onChange={e => setTreaty_name(e.target.value)} type="text" className="form-control" placeholder="Treaty Name" />
                </div>
                ...
                <div className="form-group">
                    <button onClick={createTreatyProgram} disabled={!treaty_name || !treaty_type} className="btn btn-primary btn-sm w-md">Create Treaty Program</button>
                </div>
            </div>
        </div>
    )
