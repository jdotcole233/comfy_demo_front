...
import { FETCH_CLASS_OF_BUSINESS, CLASS_OF_BUSINESS } from '../../graphql/queries';
...
export const UpdateClassOfBusiness = ({ data, toggle }) => {
    ...
    const { data: classOfBusiness, loading } = useQuery(CLASS_OF_BUSINESS, { variables: { id: data ? data?.class_of_business_id : "1" }, fetchPolicy: "network-only" })
        ...
        <>
            ...
            {!loading && classOfBusiness ? <div>
                ...
                <fieldset className="border p-1 mb-2">
                    <legend style={{ fontSize: 16 }} className="w-auto">Business Overview</legend>
                    <div className="row">
                                ...
                                <div className="card-body">
                                    <div className="media">
                                        <div className="media-body">
                                            ...
                                            <h4 className="mb-0">{classOfBusiness?.singleClassOfBusiness.single_total_offers}</h4>
                                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="card mini-stats-wid">
                                <div className="card-body">
                                    <div className="media">
                                        <div className="media-body">
                                            <p className="text-muted font-weight-medium">Fac. Premium</p>
                                            <CurrencyValues data={JSON.parse(classOfBusiness?.singleClassOfBusiness.single_total_overview)} />
                                        </div>
                ...
                <div className="form-group">
                    ...
                    <input type="text" value={businessname} onChange={e => setBusinessname(e.target.value)} className="form-control" placeholder="eg. Marine Cargo" />
                </div>
                <div className="form-group">
