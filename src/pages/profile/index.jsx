...
const Profile = () => {
    ...
    const { data: employee } = useQuery(EMPLOYEE, { variables: { id: state.user.employee.employee_id }, fetchPolicy: "network-only" });
    ...
    const handleChangePassword = values => {
        swal({
            ...
            if (!input) throw {}
            changePassword({ variables: { id: state.user.employee.employee_id, password: values.password } })
                .then(res => { swal.close() })
        })
    }
    ...
    return (
        <Fragment>
                                ...
                                <div className="card-body pt-0">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12">
                                            ...
                                            <p className="text-muted mb-0 text-truncate">{state.user?.position}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table className="table-nowrap mb-0 table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{state.user?.employee?.employee_first_name} {state.user?.employee?.employee_last_name}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div className="card-body">
                                            <div className="media">
                                                <div className="media-body">
                                                    ...
                                                    <h4 className="mb-0">{employee ? employee.employee.total_offers.length : 0}</h4>
                                                </div>
                                ...
                                <div className="col-md-6">
                                    <div className="card mini-stats-wid">
                                        <div className="card-body">
                                            <div className="media">
                                                <div className="media-body">
                                                    <p className="text-muted font-weight-medium">Last login</p>
                                                    <h4 className="mb-0">{employee?.employee?.log_activities.length > 1 ? employee.employee.log_activities[1].created_at : new Date().toDateString()}</h4>
                                                </div>
                                ...
                                <div className="col-md-12">
                                    <div className="card mini-stats-wid">
                                        <div className="card-body">
                                            ...
                                            <Datatable entries={4} columns={columns} data={employee ? employee.employee.log_activities : []} />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <Modal show={showChangePasswordModal} onHide={() => setShowChangePasswordModal(!showChangePasswordModal)}>
                ...
                <Modal.Body>
                    <form onSubmit={handleSubmit(handleChangePassword)} className="form">
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" name="password_repeat" ref={register({
                                validate: value =>
                                    value === password.current || "The passwords do not match"
                            })} className="form-control" placeholder="Confirm new password" />
                            {errors.password_repeat && <p className="text-danger">{errors.password_repeat.message}</p>}
                        </div>
                        <div className="form-group d-flex justify-content-end">
                            <button className="btn btn-primary w-md " type="submit">Change password</button>
                        </div>
                    </form>
                </Modal.Body>
            </Modal>
