...
function SendSingleDebitNote({ offer, toggle, reinsurer_id, share }) {
    ...
    const [sendmail] = useMutation(SEND_CLAIM_DEBIT_NOTE);
    ...
    return (
        <>
            <div className={styles.card_header}>
                <h2 className={styles.card_title}>Send Claim Debit Note</h2>
                <Alert variant="danger">
                    <p>A copy of the claim debit note will be sent to all associates of of this offer [<strong>{offer?.offer_detail.policy_number}</strong>]</p>
