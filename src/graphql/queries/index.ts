...
export const OFFERS = gql`
  query Offers($offer_status: [String]!, $skip: Int, $approval_status: String) {
    offers(
...
export const GET_ISNURER_DEDUCTIONS = gql`
  query InsurerDeductions($id: ID!, $offer_id: ID, $payment_id: ID!) {
...
export const INSURER_OFFERS = gql`
  ...
  query InsurerOffers($skip: Int, $id: ID) {
...
export const REINSURER_OFFERS = gql`
  query ReinsurerOffers($skip: Int, $id: ID) {
...
export const GET_ENDORSEMENT_PARTICIPATION = gql`
  query EndorsementParticipants($id: ID) {
