...
export interface ReinstatmentOffers_reinstate_offers_offers_employee {
  __typename: "Employee";
  emp_abbrv: string | null;
}

export interface ReinstatmentOffers_reinstate_offers_offers_document_messages_employee {
  __typename: "Employee";
  emp_abbrv: string | null;
  employee_id: string;
}

export interface ReinstatmentOffers_reinstate_offers_offers_document_messages {
  __typename: "Document_message";
  offersoffer_id: string | null;
  document_message: string | null;
  created_at: any | null;
  employee: ReinstatmentOffers_reinstate_offers_offers_document_messages_employee | null;
}

export interface ReinstatmentOffers_reinstate_offers_offers_exchange_rate {
...
export interface ReinstatmentOffers_reinstate_offers_offers_offer_claims_offer_claim_participants {
...
export interface ReinstatmentOffers_reinstate_offers_offers_offer_claims {
  ...
  claim_date: any | null;
  created_at: any | null;
  offer_claim_participants: (ReinstatmentOffers_reinstate_offers_offers_offer_claims_offer_claim_participants | null)[] | null;
}

export interface ReinstatmentOffers_reinstate_offers_offers_offer_endorsements_offer_endorsement_detail {
...
export interface ReinstatmentOffers_reinstate_offers_offers_offer_endorsements {
  ...
  offer_endorsement_detail: ReinstatmentOffers_reinstate_offers_offers_offer_endorsements_offer_endorsement_detail | null;
  commission_amount: number | null;
}

export interface ReinstatmentOffers_reinstate_offers_offers_offer_participant_offer_extra_charges {
...
export interface ReinstatmentOffers_reinstate_offers_offers_offer_participant_offer_deduction_charge {
...
export interface ReinstatmentOffers_reinstate_offers_offers_offer_participant_reinsurer_reinsurer_address {
  __typename: "Reinsurer_address";
  country: string;
}

export interface ReinstatmentOffers_reinstate_offers_offers_offer_participant_reinsurer {
  __typename: "Reinsurer";
  reinsurer_id: string | null;
  re_company_name: string;
  re_company_email: string;
  reinsurer_address: ReinstatmentOffers_reinstate_offers_offers_offer_participant_reinsurer_reinsurer_address;
}

export interface ReinstatmentOffers_reinstate_offers_offers_offer_participant {
  ...
  offer_extra_charges: ReinstatmentOffers_reinstate_offers_offers_offer_participant_offer_extra_charges | null;
  offer_deduction_charge: ReinstatmentOffers_reinstate_offers_offers_offer_participant_offer_deduction_charge | null;
  reinsurer: ReinstatmentOffers_reinstate_offers_offers_offer_participant_reinsurer;
}

export interface ReinstatmentOffers_reinstate_offers_offers_insurer_insurer_address {
...
export interface ReinstatmentOffers_reinstate_offers_offers_insurer {
  ...
  insurer_address: ReinstatmentOffers_reinstate_offers_offers_insurer_insurer_address | null;
}
...
export interface ReinstatmentOffers_reinstate_offers_offers {
  ...
  employee: ReinstatmentOffers_reinstate_offers_offers_employee;
  document_messages: (ReinstatmentOffers_reinstate_offers_offers_document_messages | null)[] | null;
  exchange_rate: ReinstatmentOffers_reinstate_offers_offers_exchange_rate | null;
  ...
  offer_claims: (ReinstatmentOffers_reinstate_offers_offers_offer_claims | null)[] | null;
  offer_endorsements: (ReinstatmentOffers_reinstate_offers_offers_offer_endorsements | null)[] | null;
  offer_participant: (ReinstatmentOffers_reinstate_offers_offers_offer_participant | null)[] | null;
