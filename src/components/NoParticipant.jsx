  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.1"
      ></path>
      <path fill="#b77b7f" d="M599.77 392.2H620.84V400.13H599.77z"></path>
      <path
      ...
      ></path>
      <path fill="#fff" d="M466.6 119.3H749.96V391H466.6z"></path>
      <path
        fill="#dda2a6"
      ...
      <path
        ...
        transform="translate(-100.52 -33.01)"
      ></path>
      <circle cx="608.28" cy="103.61" r="4.18" opacity="0.1"></circle>
      <circle cx="608.28" cy="102.71" r="4.18" fill="#b77b7f"></circle>
      <path d="M598.42 111.53H618.15V114.22H598.42z" opacity="0.1"></path>
      <path
        d="M590.35 115.12H626.22V121.10000000000001H590.35z"
        opacity="0.1"
      ></path>
      <path fill="#dda2a6" d="M590.35 113.32H626.22V119.3H590.35z"></path>
      <path
      ...
      <path
        ...
        opacity="0.1"
      ></path>
      <path d="M599.77 392.2H620.84V395.49H599.77z" opacity="0.1"></path>
      <path
      ...
      <path
        ...
        transform="translate(-100.52 -33.01)"
      ></path>
      <circle cx="387.68" cy="206.09" r="34.52" fill="#efb7b9"></circle>
      <path
        fill="#efb7b9"
      ...
      <circle
        ...
        opacity="0.1"
      ></circle>
      <circle cx="12" cy="93.02" r="12" fill="#6c63ff" opacity="0.1"></circle>
    </svg>
  );
}
