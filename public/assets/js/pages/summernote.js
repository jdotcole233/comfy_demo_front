  ...
  return (function (t) {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "stylePara",
              value: function (t, e) {
                i.a.each(t.nodes(ft.isPara, { includeAncestor: !0 }), function (
                  t,
                  n
                ) {
                  i()(n).css(e);
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                e = (e = (e =
                  e || kt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                var n,
          ...
          (this.insertParagraph = this.wrapCommand(function () {
            ...
            (this.createLink = this.wrapCommand(function (t) {
              ...
              if (!(l > 0 && n.isLimited(l))) {
                ...
                n.setLastRange(
                  kt.create(h.node, h.offset, f.node, f.offset).select()
                );
              }
            })),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  t.isOnAnchor() &&
                    (t = kt.createFromNode(ft.ancestor(t.sc, ft.isAnchor))),
                  t.toString()
                );
              },
            },
            ...
            },
            {
              ...
              value: function (t) {
                if (
                  ...
                  t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (
                    t
                  ) {
                    if (
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                (this.$placeholder = i()('<div className="note-placeholder">')),
                  this.$placeholder
                    .on("click", function () {
                        ...
                        items:
                          (n
                            ? [
                                ...
                                "<div>",
                                '<button type="button" className="note-color-select btn btn-light" data-event="openPalette" data-value="backColorPicker">',
                          ...
                          (o
                            ? [
                                ...
                                "<div>",
                                '<button type="button" className="note-color-select btn btn-light" data-event="openPalette" data-value="foreColorPicker">',
                                this.lang.color.cpSelect,
                                "</button>",
                    ...
                    return t.ui
                      .buttonGroup([
                        t.button({
                          className: "dropdown-toggle",
                          contents: t.ui.dropdownButtonContents(
                            '<span className="note-current-fontsizeunit"/>',
                            t.options
                          ),
              ...
              value: function () {
                var t = this.options.dialogsInBody
                  ...
                  e = [
                    ...
                    '<label htmlFor="note-dialog-link-txt-'
                      .concat(this.options.id, '" className="note-form-label">')
                      .concat(this.lang.link.textToDisplay, "</label>"),
                    '<input id="note-dialog-link-txt-'.concat(
                      this.options.id,
                      '" className="note-link-text form-control note-form-control note-input" type="text"/>'
                    ),
                    "</div>",
                    '<div className="form-group note-form-group">',
                    '<label htmlFor="note-dialog-link-url-'
                      .concat(this.options.id, '" className="note-form-label">')
                      .concat(this.lang.link.url, "</label>"),
                    '<input id="note-dialog-link-url-'.concat(
                      this.options.id,
                      '" className="note-link-url form-control note-form-control note-input" type="text" value="http://"/>'
                    ),
                    "</div>",
                  ...
                  n = '<input type="button" href="#" className="'
                    .concat(
              ...
              value: function () {
                ...
                var o = this.options.dialogsInBody
                  ...
                  i = [
                    ...
                    '<label htmlFor="note-dialog-image-file-' +
                      this.options.id +
                    ...
                    '<label htmlFor="note-dialog-image-url-' +
                      this.options.id +
                      '" className="note-form-label">' +
                      this.lang.image.url +
                      "</label>",
                    '<input id="note-dialog-image-url-' +
                      this.options.id +
                      '" className="note-image-url form-control note-form-control note-input" type="text"/>',
                    "</div>",
                  ].join(""),
                  r = '<input type="button" href="#" className="'
                    .concat(
              ...
              value: function () {
                var t = this.options.dialogsInBody
                  ...
                  e = [
                    ...
                    '<label htmlFor="note-dialog-video-url-'
                      .concat(this.options.id, '" className="note-form-label">')
                      .concat(
                        this.lang.video.url,
                    ...
                    '<input id="note-dialog-video-url-'.concat(
                      this.options.id,
                      '" className="note-video-url form-control note-form-control note-input" type="text"/>'
                    ),
                    "</div>",
                  ].join(""),
                  n = '<input type="button" href="#" className="'
              ...
              value: function () {
                var t = this.options.dialogsInBody
                  ...
                  e = [
                    ...
                    '<a href="http://summernote.org/" target="_blank">Summernote 0.8.16</a> Â· ',
            ...
            },
            {
              ...
              value: function () {
                ...
                return Object.keys(e)
                  .map(function (n) {
                    var o = e[n],
                      r = i()('<div><div className="help-list-item"/></div>');
                    return (
                      r
                        .append(
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return e.map(function (e) {
                  var o = i()('<div className="note-hint-item"/>');
                  return (
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  o = i()(
                    '<div className="note-hint-group note-hint-group-' + t + '"/>'
                  );
                return (
    ...
    53: function (t, e, n) {
      ...
      var s = r.a.create('<div className="note-editor note-frame card"/>'),
        l = r.a.create(
          '<div className="note-toolbar card-header" role="toolbar"></div>'
        ),
        c = r.a.create('<div className="note-editing-area"/>'),
        u = r.a.create(
          '<textarea className="note-codable" aria-multiline="true"/>'
        ),
        d = r.a.create(
          '<div className="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'
        ),
        h = r.a.create(
          [
            '<output className="note-status-output" role="status" aria-live="polite"/>',
            '<div className="note-statusbar" role="status">',
            '<output className="note-status-output" aria-live="polite"></output>',
        ...
        v = r.a.create(
          '<div className="note-dropdown-menu dropdown-menu" role="list">',
          function (t, e) {
        ...
        b = r.a.create(
          '<div className="note-dropdown-menu dropdown-menu note-check" role="list">',
          function (t, e) {
            var n = Array.isArray(e.items)
              ? e.items
                  .map(function (t) {
        ...
        y = r.a.create(
          '<div className="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
          function (t, e) {
                ...
                [
                  ...
                  e.title
                    ? '<div className="modal-header"><h4 className="modal-title">' +
                      e.title +
                      '</h4><button type="button" className="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>'
                    : "",
        ...
        w = r.a.create('<div className="form-check"></div>', function (t, e) {
          t.html(
            [
              '<label className="form-check-label"' +
                (e.id ? ' htmlFor="note-' + e.id + '"' : "") +
                ">",
        ...
        x = function (t) {
          return {
            ...
            palette: function (e, n) {
              return r.a.create('<div className="note-color-palette"/>', function (
                e,
                n
              ) {
                for (var o = [], i = 0, r = n.colors.length; i < r; i++) {
                  ...
                  o.push(
                    '<div className="note-color-row">' + c.join("") + "</div>"
                  );
                }
                e.html(o.join("")),
                  n.tooltip &&
